...
namespace ProjetoAspNetCore.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", 1000.0, new DateTime(1994, 4, 21), d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 1000.0, new DateTime(1998, 5, 15), d3);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 1000.0, new DateTime(1990, 10, 23), d2);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 1000.0, new DateTime(1985, 5, 26), d4);
            Seller s5 = new Seller(5, "João Black", "joao@gmail.com", 1000.0, new DateTime(1994, 1, 24), d2);
            Seller s6 = new Seller(6, "Lucia Violet", "lucia@gmail.com", 1000.0, new DateTime(1991, 12, 20), d1);
